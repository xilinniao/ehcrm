...
var gTitleName = "&nbsp;";
var gDefaultLogin = "/common/loading.html";
...
if(event.button == 1 || event.button == 0){
   gX = window.event.clientX;
   gY = window.event.clientY;
   gZ = obj.style.zIndex;
...
if( gMouseMove ){
   ...
   oldwin.style.left = pixParse(oldwin.style.left) + window.event.clientX - gX;
   oldwin.style.top =   pixParse(oldwin.style.top) + window.event.clientY - gY;
   gX = window.event.clientX;
   gY = window.event.clientY;
}
}
