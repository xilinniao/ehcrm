...
<html>
  <head>
	...
	<script language="JavaScript"><!--
		function onClick(meetId,meetName){
			var rtnTxt=meetId+"$$$"+meetName;			
			window.returnVal = rtnTxt;
		...
		tree.nodes['0_${b.recId}'] = 'text:${b.name};method:onClick("${b.recId}","${b.name}","${b.treeNo}")';
		</c:if>
		<c:if test="${myVar.index != 0}">
		tree.nodes['${b.parent.recId}_${b.recId}'] = 'text:${b.name};method:onClick("${b.recId}","${b.name}","${b.treeNo}")';
		</c:if>
		</c:forEach>
