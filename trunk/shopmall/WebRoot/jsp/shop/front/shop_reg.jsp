		...
		<form id="custregform" method="POST" action="<%=path %>/front/login.xhtml?method=onCustreg">
		    <div class="form">
                <div class="item">
				    ...
				    <div class="fl">
					    <input type="text" id="custCode" name="custCode" class="text {required: true,byteRangeLength: [3,15],remote: '<%=path%>/front/login.xhtml?method=checkUser', messages: {required:'请输入用户名',remote: '用户名已存在,请重新输入!'}}" tabindex="1" value="${custInfo.custCode }" />
					    <span class="clr"></span>                        
				    </div>
			    </div>
			    <div class="item">
				    ...
				    <div class="fl">
					    <input type="password" class="text {required: true,minlength: 5,messages: {required:'请输入密码'}}" id="custPwd" name="custPwd" tabindex="2">
					    <span class="clr"></span>    						
				    </div>
			    </div>
			    <div class="item">
				    ...
				    <div class="fl">
					    <input type="password" class="text {required: true,minlength: 5,equalTo: '#custPwd',messages: {required:'请输入确认密码',equalTo:'两次输入的密码不一致'}}" id="custPwd2" name="custPwd2" tabindex="3">
					    <span class="clr"></span>    						
				    </div>
			    </div>
			    <div class="item">
				    ...
				    <div class="fl">
					    <input type="text" id="email" name="email" class="text {required: true,email: true,messages: {required:'请输入电子邮件'}}" tabindex="4">			
					    <span class="clr"></span>    					
				    </div>
			    </div>
			    <div class="item" style="height:70px;">
				    ...
				    <div class="fl">
					    <input type="text" id="authcode" name="authcode" class="text-s {required: true,rangelength:[4,4],messages: {required:'请输入验证码',rangelength:'请输入四位验证码'}}" tabindex="6" maxlength="5">
					    <br/>请输入以下验证码
					    <span class="clr"></span>                       
			    	</div>			    
			    </div>
