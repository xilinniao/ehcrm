            ...
            <form id="addrform" method="POST" action="<%=path %>/front/user.xhtml?method=onProfile">
	            <div id="userform" class="form">
				    ...
				    <div class="item">
					    ...
					    <div class="fl">
						    <input type="test" class="text {required: true} valid" id="custName" name="custName" tabindex="2" value="${custInfo.custName}" />
						    <span class="clr"></span>    						
					    </div>
				    </div>
				    ...
				    <div class="item">
					    ...
					    <div class="fl">
						    <input type="test" class="text {required: true} valid" id="custAddr" name="custAddr" tabindex="2" value="${custInfo.custAddr}" />
						    <span class="clr"></span>    						
					    </div>
				    </div>
				    ...
				    <div class="item">
					    ...
					    <div class="fl">
						    <input type="test" class="text {required: true} valid" id="custMobile" name="custMobile" tabindex="3" value="${custInfo.custMobile}" />
						    <span class="clr"></span>    						
					    </div>
				    </div>
				    ...
				    <div class="item">
					    ...
					    <div class="fl">
						    <input type="test" class="text {email: true} valid" id="email" name="email" tabindex="4" value="${custInfo.email}" />
						    <span class="clr"></span>    						
					    </div>
				    </div>
