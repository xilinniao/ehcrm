...
<title><%=projName %></title>
  ...
  <body class="input">
  	<div class="inputBar">
		<h1><span class="icon">&nbsp;</span>订单管理-&gt订单发货<span class="right">(订单编号：${order.orderNo})</span></h1>
	</div>
	 <div class="box column-center">
		<div class="box-content form-table" style="display: block; ">			
				<form action="<%=path%>/shop/admin/orders.xhtml?method=onSend" class="validate" id="saveform" name="saveform" method="post">
						...
						<table border="0" cellspacing="0" cellpadding="0" class="inputTable tabContent" style="display: table;">
							<tbody>	
							   <tr>
							    <th nowrap>送货人姓名</th>
								<td><input type="text" name="sendName" class="formText {required: true,messages: {required:'请输入送货人姓名'}}" id="name" value=""></td>
							  </tr>					  
							  <tr>
							    <th nowrap>联系电话</th>
								<td><input type="text" name="sendTel" class="formText {required: true,messages: {required:'请输入联系电话'}}" id="sendTel" value=""></td>
							  </tr>					  
							  <tr>
							    <th>送货备注</th>
								<td>
						...
						<div class="buttonArea">
							<input type="button" class="formButtonSubmit" id="btnSave" value="保存送货信息" hidefocus="true"/>
