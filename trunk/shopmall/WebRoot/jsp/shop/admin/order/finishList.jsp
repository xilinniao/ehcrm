...
<script type="text/javascript">
  ...
  <body class="list">
	...
	<input type="hidden" name="qryHex" value="${qry.qryHex}"/>
  	...
  	<div class="listBar">
		<h1><span class="icon">&nbsp;</span>待完成订单列表&nbsp;<span class="pageInfo">总记录数: ${page.totalCount}(共${page.totalPageCount}页)</span></h1>
	</div>
	
	<div class="body">
		<form id="listForm" action="<%=path %>/shop/admin/orders.xhtml?method=finishList" method="post">
