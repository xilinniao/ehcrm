...
<script type="text/javascript">
  ...
  <body class="list">
  	...
  	<form id="editForm" name="editForm" method="post" action="<%=path %>/shop/admin/orders.xhtml?method=check">
	<input type="hidden" name="orderId" id="edit_orderId" value=""/>
	<input type="hidden" name="qryHex" value="${qry.qryHex}"/>
	</form>

  	<div class="listBar">
		<h1><span class="icon">&nbsp;</span>订单列表&nbsp;<span class="pageInfo">总记录数: ${page.totalCount}(共${page.totalPageCount}页)</span></h1>
	</div>
