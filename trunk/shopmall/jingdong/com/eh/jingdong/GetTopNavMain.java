...
public class GetTopNavMain {
	...
	public static void main(String[] args) {
		...
		ul.append("<li><a href=\"/index.xhtml\" class=\"home\">首页</a></li>");
		for(TbSiteCategory levela:categoryList){
			ul.append("<li><a href=\"/category/"+levela.getCategoryId()+".html\" id=\"category_"+levela.getCategoryDesc()+"\" class=\"products\">"+levela.getCategoryName()+"</a><div class=\"sub\">");
