...
/**
 * TbShopInfo entity. @author MyEclipse Persistence Tools
 */
...
public class TbShopInfo  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbShopInfo(String shopName, String shopDesc, String idNo, String shopAddr, String linkerMan, String linkerMobile, String linkTel, String email, TbUserInfo admin, Long imgLogo, Long imgoAd, Date foundDate, Date modiDate) {
        this.shopName = shopName;
