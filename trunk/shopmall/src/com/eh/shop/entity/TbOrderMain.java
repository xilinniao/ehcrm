...
public class TbOrderMain implements java.io.Serializable {
	...
	/** full constructor */
	public TbOrderMain(TbCustInfo custInfo, TbShopInfo shopInfo,
			String orderNo, String revicedName, String revicedAddr,
			String revicedMobile, String revicedTel, String revicedEmail,
			String orderRemark, Double orderMoney, Double fareFee,
			Long usesScore, String orderStatus, Date orderTime) {
	...
	public String getOrderStatusStr(){
		return FormateUtil.getInstance().getNameByCode("s_order_status", this.orderStatus);
	}
