...
<title><%=projName %></title>
	...
	$(document).ready(function(){
		$("#${moduleName}_tree").jstree({
			...
			parent.$('#parent${moduleName?cap_first}Id').val(data.rslt.obj.attr("id").substr(3));
			parent.$('#parent${moduleName?cap_first}Name').val(data.args[0].innerText.trim());
  ...
  <body class="input">
  	<div class="inputBar">
		<h1><span class="icon">&nbsp;</span>选择${moduleNameChn}</h1>
	</div>	
	<div class="box column-center">
		<div class="box-content min-height-500" id="${moduleName}_tree" style="display: block; "></div>
	</div>
  </body>
</html>